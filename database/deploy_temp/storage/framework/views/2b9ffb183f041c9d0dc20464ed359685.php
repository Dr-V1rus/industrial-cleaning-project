...
<body class="bg-white">
    ...
    <nav class="bg-white shadow-lg sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                <a href="/" class="text-2xl font-bold text-blue-700"><?php echo e($settings['site_name'] ?? "Oriefi's"); ?> <span
                ...
                <a href="https://wa.me/<?php echo e($settings['whatsapp_number'] ?? '2348032068718'); ?>" target="_blank"
    ...
    <div class="hero-slider">
        <div class="slides">
            <div class="slide" style="background-image: url('<?php echo e(asset('images/hero1.jpeg')); ?>');"></div>

            <div class="slide" style="background-image: url('<?php echo e(asset('images/hero2.jpeg')); ?>');"></div>

            <div class="slide" style="background-image: url('<?php echo e(asset('images/hero3.jpeg')); ?>');"></div>

            <div class="slide" style="background-image: url('<?php echo e(asset('images/hero4.jpeg')); ?>');"></div>

            <div class="slide" style="background-image: url('<?php echo e(asset('images/house_cleaning.jpeg')); ?>');"></div>
        </div>

        <div class="hero-content">
            <h1 class="text-5xl md:text-7xl font-bold mb-4">
                <?php echo e($settings['hero_title'] ?? 'Professional Cleaning Services'); ?>

            </h1>
            <p class="text-xl md:text-2xl mb-8">
                <?php echo e($settings['hero_subtitle'] ?? 'Industrial-grade equipment for spotless results'); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 grid md:grid-cols-2 mt-28 gap-12">
        <div><img src="<?php echo e(asset('images/cleaning_image.jpeg')); ?>" alt="Team" class="rounded-2xl shadow-xl w-full"></div>
        <div>
        ...
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden card-hover">
                    <img src="<?php echo e(asset('images/cleaning_in_progress2.jpeg')); ?>" alt="Cleaning"
                ...
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden card-hover">
                    <img src="<?php echo e(asset('images/cleaning_in_progress.jpeg')); ?>" alt="Office Cleaning"
                        class="w-full h-56 object-cover">
                    <div class="p-6">
                        <div class="w-14 h-14 bg-blue-100 rounded-full flex items-center justify-center mb-4">
                ...
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden card-hover">
                    <img src="<?php echo e(asset('images/greenworks_machine.jpeg')); ?>" alt="Pressure Washing"
                        class="w-full h-56 object-cover">
                    <div class="p-6">
                        <div class="w-14 h-14 bg-blue-100 rounded-full flex items-center justify-center mb-4">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <div class="rounded-2xl overflow-hidden shadow-xl">
                    <video class="w-full h-[450px] object-cover" controls
                        poster="<?php echo e(asset($settings['video_1_poster'] ?? 'images/video-poster1.jpg')); ?>">
                        <source src="<?php echo e(asset($settings['video_1_url'] ?? 'videos/cleaning_video1.mp4')); ?>"
                            type="video/mp4">
                    </video>
                ...
                <div class="rounded-2xl overflow-hidden shadow-xl">
                    <video class="w-full h-[450px] object-cover" controls
                        poster="<?php echo e(asset($settings['video_2_poster'] ?? 'images/video-poster2.jpg')); ?>">
                        <source src="<?php echo e(asset($settings['video_2_url'] ?? 'videos/cleaning_video2.mp4')); ?>"
                            type="video/mp4">
                    </video>
...
</html><?php /**PATH C:\Users\HP\Desktop\xampp\htdocs\oriefi-cleaning\resources\views/welcome.blade.php ENDPATH**/ ?>